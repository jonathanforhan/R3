...
// vec export
template struct R3_API glm::vec<1, glm::f32, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::f32, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::f32, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::f32, glm::packed_highp>;
template struct R3_API glm::vec<1, glm::f64, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::f64, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::f64, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::f64, glm::packed_highp>;
template struct R3_API glm::vec<1, glm::i32, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::i32, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::i32, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::i32, glm::packed_highp>;
template struct R3_API glm::vec<1, glm::i64, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::i64, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::i64, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::i64, glm::packed_highp>;
template struct R3_API glm::vec<1, glm::u32, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::u32, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::u32, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::u32, glm::packed_highp>;
template struct R3_API glm::vec<1, glm::u64, glm::packed_highp>;
template struct R3_API glm::vec<2, glm::u64, glm::packed_highp>;
template struct R3_API glm::vec<3, glm::u64, glm::packed_highp>;
template struct R3_API glm::vec<4, glm::u64, glm::packed_highp>;

// mat export
template struct R3_API glm::mat<2, 2, glm::f32, glm::packed_highp>;
template struct R3_API glm::mat<3, 3, glm::f32, glm::packed_highp>;
template struct R3_API glm::mat<4, 4, glm::f32, glm::packed_highp>;
template struct R3_API glm::mat<2, 2, glm::f64, glm::packed_highp>;
template struct R3_API glm::mat<3, 3, glm::f64, glm::packed_highp>;
template struct R3_API glm::mat<4, 4, glm::f64, glm::packed_highp>;

// quat export
template struct R3_API glm::qua<glm::f32, glm::packed_highp>;
template struct R3_API glm::qua<glm::f64, glm::packed_highp>;
