...
TextureBuffer::TextureBuffer(const TextureBufferSpecification& spec)
    ...
    void* data = m_spec.logicalDevice->as<vk::Device>().mapMemory((VkDeviceMemory)stagingMemory, 0, imageSize, {});
    {
        // no Alpha channel
        if (channels == 3) {
            ...
            for (int32 i = 0, j = 0; i < rgbSize; i += 3, j++) {
        ...
        // has Alpha Channel
            ...
            memcpy(data, bytes, usize(imageSize));
        }
    }
