...
/// @brief Vulkan GraphicsPipeline Specification.
/// ShaderModules must be moved as r-value references because the GraphicsPipeline will take ownership of them. There is
/// no need to manually track the shaders passed in as they will be invalidated on move.
...
/// @brief Vulkan GraphicsPipeline RAII wrapper.
/// GraphicsPipeline takes ownership of all ShaderModules passed to it during creation and will free them in the
...
public:
    ...
    /// @brief Construct GraphicsPipeline.
    /// On construction GraphicsPipeline creates the VkPipelineLayout, and the VkPipeline. The Viewport and Scissor are
