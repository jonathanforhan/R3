...
/// After initializing a VkInstance, R3 can now look for a graphics card; the VkPhysicalDevice. This class provides
/// means of checking for support and evalutaing which graphics card is the best fit for the application. R3 does not
/// support usage of multiple graphics cards at once (at an API level).
