...
R3_DLL void Run() {
    try {
        ...
        // entity.emplace<ModelComponent>("assets/glTF/Models/RiggedFigure/glTF-Binary/RiggedFigure.glb");
        entity.emplace<ModelComponent>("assets/glTF/Models/AnimatedCube/glTF/AnimatedCube.gltf");
        // entity.emplace<ModelComponent>("assets/glTF/Models/AnimatedMorphCube/glTF-Binary/AnimatedMorphCube.glb");
